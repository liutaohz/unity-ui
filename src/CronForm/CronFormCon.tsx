...
const Cron = (props: { cronExpression: string }, ref: any) => {
   ...
   * @param fun
   */
  const handleCheckboxChange = (checkedValues: any, type: string, fun: any) => {
    // select双向绑定
                ...
                >
                  ...
                  <Radio style={radioStyle} value="period">
                    ...
                    <InputNumber
                      ...
                      onChange={(e) =>
                        handlePeriodChange(e as number, 'second', 'min')
                      }
                    />
                    -
                    <InputNumber
                      ...
                      onChange={(e) =>
                        handlePeriodChange(e as number, 'second', 'max')
                      }
                    />
                    秒
                  </Radio>
                  <Radio style={radioStyle} value="loop">
                    ...
                    <InputNumber
                      ...
                      onChange={(e) =>
                        handleLoopChange(e as number, 'second', 'start')
                      }
                    />
                    秒开始，每
                    <InputNumber
                      ...
                      onChange={(e) =>
                        handleLoopChange(e as number, 'second', 'end')
                      }
                    />
                    秒执行一次
                  </Radio>
                  <Row>
                    ...
                    <Col span={18}>
                      <Select
                        ...
                        placeholder="请选择秒"
                        onChange={(value) =>
                          handleCheckboxChange(value, 'second', setPointValue)
                        }
                ...
                >
                  ...
                  <Radio style={radioStyle} value="period">
                    ...
                    <InputNumber
                      ...
                      onChange={(e) =>
                        handlePeriodChange(e as number, 'minute', 'min')
                      }
                    />
                    -
                    <InputNumber
                      ...
                      onChange={(e) =>
                        handlePeriodChange(e as number, 'minute', 'max')
                      }
                    />
                    分
                  </Radio>
                  <Radio style={radioStyle} value="loop">
                    ...
                    <InputNumber
                      ...
                      onChange={(e) =>
                        handleLoopChange(e as number, 'minute', 'start')
                      }
                    />
                    分开始，每
                    <InputNumber
                      ...
                      onChange={(e) =>
                        handleLoopChange(e as number, 'minute', 'end')
                      }
                    />
                    分执行一次
                  </Radio>
                  ...
                  <Row>
                    ...
                    <Col span={18}>
                      <Select
                        ...
                        placeholder="请选择分钟"
                        onChange={(value) =>
                          handleCheckboxChange(value, 'minute', setPointValue)
                        }
                        options={createSelectOption(59)}
                      />
                    </Col>
                ...
                >
                  ...
                  <Radio style={radioStyle} value="period">
                    ...
                    <InputNumber
                      ...
                      onChange={(e) =>
                        handlePeriodChange(e as number, 'hour', 'min')
                      }
                    />
                    -
                    <InputNumber
                      ...
                      onChange={(e) =>
                        handlePeriodChange(e as number, 'hour', 'max')
                      }
                    />
                    时
                  </Radio>
                  <Radio style={radioStyle} value="loop">
                    ...
                    <InputNumber
                      ...
                      onChange={(e) =>
                        handleLoopChange(e as number, 'hour', 'start')
                      }
                    />
                    时开始，每
                    <InputNumber
                      ...
                      onChange={(e) =>
                        handleLoopChange(e as number, 'hour', 'end')
                      }
                    />
                    时执行一次
                  </Radio>
                  ...
                  <Row>
                    ...
                    <Col span={18}>
                      <Select
                        ...
                        placeholder="请选择小时"
                        onChange={(value) =>
                          handleCheckboxChange(value, 'hour', setPointValue)
                        }
                ...
                >
                  ...
                  <Radio style={radioStyle} value="period">
                    ...
                    <InputNumber
                      ...
                      onChange={(e) =>
                        handlePeriodChange(e as number, 'day', 'min')
                      }
                    />
                    -
                    <InputNumber
                      ...
                      onChange={(e) =>
                        handlePeriodChange(e as number, 'day', 'max')
                      }
                    />
                    日
                  </Radio>
                  <Radio style={radioStyle} value="loop">
                    ...
                    <InputNumber
                      ...
                      onChange={(e) =>
                        handleLoopChange(e as number, 'day', 'start')
                      }
                    />
                    日开始，每
                    <InputNumber
                      ...
                      onChange={(e) =>
                        handleLoopChange(e as number, 'day', 'end')
                      }
                    />
                    日执行一次
                  </Radio>
                  ...
                  <Row>
                    ...
                    <Col span={18}>
                      <Select
                        ...
                        placeholder="请选择日期"
                        onChange={(value) =>
                          handleCheckboxChange(value, 'day', setPointValue)
                        }
                        options={createSelectOption(23)}
                      />
                    </Col>
                ...
                >
                  ...
                  <Radio style={radioStyle} value="period">
                    ...
                    <InputNumber
                      ...
                      onChange={(e) =>
                        handlePeriodChange(e as number, 'month', 'min')
                      }
                    />
                    -
                    <InputNumber
                      ...
                      onChange={(e) =>
                        handlePeriodChange(e as number, 'month', 'max')
                      }
                    />
                    月
                  </Radio>
                  <Radio style={radioStyle} value="loop">
                    ...
                    <InputNumber
                      ...
                      onChange={(e) =>
                        handleLoopChange(e as number, 'month', 'start')
                      }
                    />
                    月开始，每
                    <InputNumber
                      ...
                      onChange={(e) =>
                        handleLoopChange(e as number, 'month', 'end')
                      }
                    />
                    月执行一次
                  </Radio>
                  <Row>
                    ...
                    <Col span={18}>
                      <Select
                        ...
                        placeholder="请选择月份"
                        onChange={(value) =>
                          handleCheckboxChange(value, 'month', setPointValue)
                        }
                  ...
                  <Row>
                    ...
                    <Col>
                      <Select
                        ...
                        placeholder="请选择周"
                        onChange={(e) =>
                          handlePeriodChange(e as number, 'week', 'min')
                        }
                    ...
                    <Col>
                      <Select
                        ...
                        placeholder="请选择周"
                        onChange={(e) =>
                          handlePeriodChange(e as number, 'week', 'max')
                        }
                        options={createWeekSelect(7)}
                      />
                    </Col>
                  ...
                  <Row>
                    ...
                    <Col span={18}>
                      <Select
                        ...
                        placeholder="请选择周"
                        onChange={(value) =>
                          handleCheckboxChange(value, 'week', setPointValue)
                        }
                        options={createWeekSelect(7)}
                      />
                    </Col>
